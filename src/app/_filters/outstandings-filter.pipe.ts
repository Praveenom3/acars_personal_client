    ...
    transform(value: any[], filter: string): any[] {
        ...
        return filter && value ?
            value.filter(outstandingInvoice =>
                ...
                ((outstandingInvoice.product_full_name != null) && (outstandingInvoice.product_full_name.toLocaleLowerCase().indexOf(filter) !== -1)) ||
                ((outstandingInvoice.invoice_no != null) && (outstandingInvoice.invoice_no.toLocaleLowerCase().indexOf(filter) !== -1)) ||
